...
| 6 | March, 18 | Autoregressive flows (MAF, IAF). Flow KL duality. Variational dequantization (Flow++). | [slides](lectures/lecture6/Isachenko2021DeepGenerativeModels6.pdf) | [slides](seminars/seminar6/seminar6.ipynb) | 
