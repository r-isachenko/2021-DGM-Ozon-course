...
\begin{frame}{Neural ODE}
	...
	\vspace{-0.3cm}
	\[
	     \frac{d \ba_{\btheta}(t)}{dt} = - \ba_{\bz}(t)^T \cdot \frac{\partial f(\bz(t), \btheta)}{\partial \btheta}
	\]
...
\begin{frame}{Neural ODE}
	...
	\end{block}
	\vspace{-0.4cm} 
	It could be shown that such transformation is generalization of usual backpropagation.
	\begin{figure}
		\centering
